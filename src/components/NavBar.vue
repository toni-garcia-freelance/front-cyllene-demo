      ...
      <div class="relative flex h-16 items-center justify-between">
        ...
        <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
          <div class="flex  gap-2 flex-shrink-0 items-center">
            <Battery0Icon  class="h-6 w-6 text-white" />      
            <Battery50Icon  class="h-6 w-6 text-white" />    
            <Battery100Icon  class="h-6 w-6 text-white" />    
          </div>
...
import { Bars3Icon, BellIcon, XMarkIcon, Battery0Icon, Battery50Icon, Battery100Icon } from '@heroicons/vue/24/outline'
